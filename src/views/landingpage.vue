      ...
      <div class="flex flex-wrap -m-4">
        ...
        <div class="w-full md:w-1/3 p-4">
          <div class="flex flex-col justify-between p-8 h-full bg-gray-900 rounded-3xl">
            ...
            <div class="flex-initial">
              <div class="flex flex-wrap -m-2">
                <div class="w-full p-2"><router-link class="block w-full px-8 py-3.5 text-lg text-center text-gray-100 font-bold bg-gray-700 hover:bg-gray-900 focus:ring-4 focus:ring-gray-400 rounded-full" to="/checkoutpremium">Purchase</router-link></div>
              </div>
            </div>
          </div>
        </div>
