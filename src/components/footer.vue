...
<!--           <li class="inline-flex p-6"><a class="inline-block text-gray-500 hover:text-gray-600 font-bold" href="#">About Us</a></li>
        ...
        <div class="flex flex-wrap justify-center -m-1.5 mb-10">
          ...
          <div class="w-auto p-1.5"><a class="flex items-center justify-center w-10 h-10 bg-gray-700 rounded-full" href="https://github.com/DecentralizeJustice/phantomwebsite"><img style='width: 60%;height: auto;' src="https://res.cloudinary.com/dylevfpbl/image/upload/v1687404904/landingpage/github.svg" alt=""></a></div>
